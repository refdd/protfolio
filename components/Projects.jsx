...
const projectData= {
  projects: [
    ...
    {id : "4" , title :"Cryptosapp" , projectUrl : "/product/cryptosapp", backgroundImg: coinShooping, buildBy: "reactjs"   },
    {id : "4" , title :"searchGoogle" , projectUrl : "/product/searchGoogle", backgroundImg: searchGoogle, buildBy: "reactjs"   },
    {id : "4" , title :"Dashboard" , projectUrl : "/product/Dashboard", backgroundImg: Dashboard, buildBy: "reactjs"   },
    {id : "4" , title :"spotify" , projectUrl : "/product/spotify", backgroundImg: spotify, buildBy: "reactjs"   },
    {id : "4" , title :"fitclub" , projectUrl : "/product/fitclub", backgroundImg: fitclub, buildBy: "reactjs"   },
    {id : "4" , title :"gym" , projectUrl : "/product/gym", backgroundImg: gym, buildBy: "javaScript"   },
    {id : "4" , title :"Dino Game" , projectUrl : "/product/dino", backgroundImg: Dino, buildBy: "javaScript"   },
    {id : "4" , title :"Snake" , projectUrl : "/product/snake", backgroundImg: Snake, buildBy: "javaScript"   },
    {id : "4" , title :"SpecialDesing" , projectUrl : "/product/SpecialDesing", backgroundImg: SpecialDesing, buildBy: "javaScript"   },
    {id : "4" , title :"color" , projectUrl : "/product/color", backgroundImg: color, buildBy: "javaScript"   },
  ]
}
function Projects() {
  return (
